        ...
        <div class="d-flex">
            ...
            @php 
             ...
             if(!empty($adminData->profile_image)){
                $src = 'upload/admin_image/'.$adminData->profile_image;
             }else{
            ...
            <div class="dropdown d-inline-block user-dropdown">
                <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown"
                    ...
                    <img class="rounded-circle header-profile-user" src="{{ url('').'/'.$src }}"
                        alt="Header Avatar">
                    <span class="d-none d-xl-inline-block ms-1">{{$adminName}}</span>
